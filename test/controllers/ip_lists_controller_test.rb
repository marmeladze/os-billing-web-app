...
class IpListsControllerTest < ActionController::TestCase
  ...
  test "should create ip_list" do
    assert_difference('IpList.count') do
      post :create, ip_list: { address: @ip_list.address, instance_id: @ip_list.instance_id, type: @ip_list.type }
    end
  ...
  test "should update ip_list" do
    patch :update, id: @ip_list, ip_list: { address: @ip_list.address, instance_id: @ip_list.instance_id, type: @ip_list.type }
    assert_redirected_to ip_list_path(assigns(:ip_list))
  end
