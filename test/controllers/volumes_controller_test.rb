...
class VolumesControllerTest < ActionController::TestCase
  ...
  test "should create volume" do
    assert_difference('Volume.count') do
      post :create, volume: { amount: @volume.amount, available: @volume.available, instance_id: @volume.instance_id, type: @volume.type, user_id: @volume.user_id }
    end
  ...
  test "should update volume" do
    patch :update, id: @volume, volume: { amount: @volume.amount, available: @volume.available, instance_id: @volume.instance_id, type: @volume.type, user_id: @volume.user_id }
    assert_redirected_to volume_path(assigns(:volume))
  end
