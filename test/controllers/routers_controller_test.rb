...
class RoutersControllerTest < ActionController::TestCase
  ...
  test "should create router" do
    assert_difference('Router.count') do
      post :create, router: { address: @router.address, creation: @router.creation, name: @router.name, status: @router.status, tenant_uid: @router.tenant_uid }
    end
  ...
  test "should update router" do
    patch :update, id: @router, router: { address: @router.address, creation: @router.creation, name: @router.name, status: @router.status, tenant_uid: @router.tenant_uid }
    assert_redirected_to router_path(assigns(:router))
  end
